            ...
            <div class="modal-dialog modal-center" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form   action="{{ route('Articulos_mayores.update',$articulo->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddress" placeholder="" name="numero_serie" value="{{$articulo->numero_serie}}">
                        </div>
                        <div class="col">
                            <label for="inputAddress">Código articulo</label>
                            <input type="text" class="form-control" placeholder="Codigo " name="codigo_articulo" value="{{$articulo->clave_producto}}">
                        </div>
                        <div class="col">
